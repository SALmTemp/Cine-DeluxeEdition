...
class User(db.Model):
    ...
    def __init__(self, id_subcripcion, id_cuenta, id_estado, id_experiencia, id_usersroles,id_notificacion,id_perfil,id_encuesta,id_ticket,id_inventario, username, email, password, fullname):
...
class UserSchema(ma.Schema):
    class Meta:
        fields = ('id_subcripcion', 'id_cuenta', 'id_estado', 'id_experiencia', 'id_perfilescreados','id_usersroles','id_notificacion','id_perfil','id_encuesta','id_ticket','username','email','password','fullname')